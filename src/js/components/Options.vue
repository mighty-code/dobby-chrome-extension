  ...
  <div class="options-page flex flex-col justify-between h-full">
    <div>
      ...
      <form @submit.prevent="setAccessToken()">
        ...
        >
        <div class="mt-1">
            <span class="italic text-sm">By adding an access token you confirm our usage <a class="text-white" :href="imprintUrl">agreement and policy</a>.</span>
        </div>
        <button type="submit" class="border py-2 px-4 rounded-full mt-3 text-white">Save</button>
      </form>
      <div class="my-6">
        <label>
